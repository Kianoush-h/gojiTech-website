...
import { ArrowLeft, BookOpen, Search, Database, CheckCircle, Shield, Users, FileText } from 'lucide-react'
  ...
  const benefits = [
    {
      ...
      description: 'Extensive formulary database covering all approved cannabis products with detailed profiles.'
    },
    {
      icon: Search,
      title: 'Advanced Search',
      description: 'Powerful search capabilities to find products by condition, cannabinoid profile, or brand.'
    },
    {
      icon: CheckCircle,
      title: 'Coverage Verification',
      description: 'Real-time verification of insurance coverage and formulary inclusion status.'
    },
    {
      icon: Shield,
      title: 'Evidence-Based',
      description: 'All formulary decisions backed by clinical evidence and regulatory compliance.'
    },
    {
      icon: Users,
      title: 'Provider Tools',
      description: 'Healthcare provider portal for formulary management and prescription guidance.'
    },
    {
      icon: FileText,
      title: 'Documentation',
      description: 'Complete documentation and justification for all formulary decisions.'
    }
  ]
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <h1 className="text-6xl lg:text-7xl font-display font-bold mb-8 leading-tight">
                    <span className="gradient-text">Formulary</span>
                    <span className="gradient-text align-super text-[0.5em] ml-1">™</span>
                  </h1>
                  
                  <p className="text-xl text-dark-600 mb-8 leading-relaxed">
                    Comprehensive cannabis formulary management system that provides evidence-based 
                    product coverage decisions and streamlines the approval process for healthcare providers.
                  </p>
            ...
            <div className="container mx-auto px-6">
              <div className="text-center mb-20">
                <h2 className="text-5xl lg:text-6xl font-display font-bold mb-8">
                  Evidence-Based <span className="gradient-text">Formulary Management</span>
                </h2>
                <p className="text-dark-600 text-xl max-w-3xl mx-auto">
                  Streamline cannabis product coverage decisions with our comprehensive 
                  formulary system built on clinical evidence and regulatory compliance.
                </p>
              </div>
              ...
              <div className="max-w-4xl mx-auto bg-transparent border border-dark-300/30 rounded-2xl p-8 md:p-10">
                <div className="text-center mb-6">
                  <span className="text-accent text-sm font-medium uppercase tracking-wider">
                    Formulary<sup className="text-[0.65em] align-super">™</sup> Insight
                  </span>
                  <h2 className="text-4xl lg:text-5xl font-display font-bold mt-3 mb-3">
                    The Science of Cannabis Formulary Design
                  </h2>
                  <p className="text-dark-600 text-lg">
                    How evidence-based formulary management transforms patient access and outcomes
                  </p>
                </div>

                <div className="space-y-6 text-dark-600 text-lg leading-relaxed">
                  <p>
                    Traditional pharmaceutical formularies have decades of clinical data to guide coverage decisions. Cannabis medicine is different—with rapidly evolving research, diverse product formats, and varying regulatory landscapes across jurisdictions.
                  </p>
                  <p>
                    Our Formulary<sup className="text-[0.65em] align-super">™</sup> system bridges this gap by integrating the latest clinical evidence, real-world outcomes data, and regulatory requirements to create dynamic, evidence-based coverage decisions. This ensures patients have access to effective treatments while maintaining cost-effectiveness for insurers.
                  </p>
                  <p>
                    By standardizing formulary management across the cannabis industry, we're creating the foundation for predictable, equitable access to cannabis medicine that patients and providers can rely on.
                  </p>
                </div>
            ...
            <div className="container mx-auto px-6">
              <div className="text-center bg-gradient-to-r from-accent/10 to-primary-500/10 border border-accent/20 rounded-3xl p-12">
                <h2 className="text-4xl font-display font-bold mb-6">
                  Ready to Implement Evidence-Based Formulary Management?
                </h2>
                <p className="text-dark-600 text-lg mb-8 max-w-2xl mx-auto">
                   Join healthcare organizations using our Formulary<sup className="text-[0.65em] align-super">™</sup> system 
                   to make informed coverage decisions and improve patient access.
                </p>
